<template>
    <div class="card h-100">
        <div class="card-header pb-0">
            ...
            <p class="text-sm">
                <i
                    class="material-icons text-sm text-success"
                    aria-hidden="true"
                    >north</i
                >
        ...
        <div class="card-body p-3">
            <div class="timeline timeline-one-side">
                ...
                <div class="timeline-block mb-3">
                    <span class="timeline-step">
                        <i
                            class="material-icons text-danger text-gradient text-lg"
                            >code</i
                        >
                    </span>
                    <div class="timeline-content">
                ...
                <div class="timeline-block mb-3">
                    <span class="timeline-step">
                        <i
                            class="material-icons text-info text-gradient text-lg"
                            >shopping_cart</i
                        >
                    </span>
                    <div class="timeline-content">
                ...
                <div class="timeline-block mb-3">
                    <span class="timeline-step">
                        <i
                            class="material-icons text-warning text-gradient text-lg"
                            >credit_card</i
                        >
                    </span>
                    <div class="timeline-content">
                ...
                <div class="timeline-block mb-3">
                    <span class="timeline-step">
                        <i
                            class="material-icons text-primary text-gradient text-lg"
                            >vpn_key</i
                        >
                    </span>
                    <div class="timeline-content">
                ...
                <div class="timeline-block" v-if="newOrder2">
                    <span class="timeline-step">
                        <i
                            class="material-icons text-dark text-gradient text-lg"
                            >payments</i
                        >
                    </span>
                    <div class="timeline-content">
